...
export default function StatsCard({ name }) {
  return (
    <div className='rounded-2xl odd:bg-gray-200 even: bg-gray-200 p-4 flex-1 group'>
      ...
      <h1 className='text-2xl font-semibold my-4 text-black group-even:text-black'>
        {/* Apply text-white if background is sky-900 (even), otherwise black */}
        1283
      </h1>
      <h1 className='capitalize font-medium text-grey-500 group-even:text-bleck'>
        {/* Apply text-white if background is sky-900 (even), otherwise black */}
        {name}
      </h1>
    </div>
